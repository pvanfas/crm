...
from users.models import NotificationSubject
    ...
    def handle(self, *args, **options):
        ...
        for user in users:
            ...
            if user.accountbalance.balance < low_balance_limit:
                ...
                content = (
                    "You have only %s %s in your Arkboss account. Please add some funds for uninterrupted service."
                ...
                create_notification(
                    request, notification_type, instance=instance.product
                )
