...
urlpatterns = [
    ...
    path(
        ...
        views.delete_selected_notifications,
        name="delete_selected_notifications",
    ),
    path(
        "notification/read/<str:pk>/", views.read_notification, name="read_notification"
    ),
    path(
        "read-selected-notifications/",
        views.read_selected_notifications,
        name="read_selected_notifications",
    ),
